pipeline {
    ...
    environment {
        GIT_URL = 'https://github.com/yooso0731/ask-mento-cloud.git'
        GIT_BRANCH = 'main' // 또는 master
        GIT_ID = 'skala-github-id' // GitHub PAT credential ID
        GIT_USER_NAME = 'yooso0731' // GitHub 사용자 이름
        GIT_USER_EMAIL = 'yooso0731@gmail.com'
        IMAGE_REGISTRY = 'amdp-registry.skala-ai.com/skala25a'
        IMAGE_NAME = 'sk046-ask-mento'
        IMAGE_TAG = '1.0.0'
